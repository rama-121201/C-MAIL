...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="row" style="height: 660px;">
        <div class="sidebar col-md-3 col-sm-3 d-md-block d-sm-block d-none" style="background-image: linear-gradient(to bottom left, #f17a09,#fc00ff);">
                  ...
                  <li class="passive">
                    <div class="my-4">
                      <a href="./profile.html" class="menu-active text-decoration-none text-white">
                        <h5><i class="bi bi-person-check ms-5 me-3 text-white"></i>Profil Saya</h5>
                      </a>
                    </div>
                  </li>               
                </ul>
                                    ...
                                    <div class="modal-dialog">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <?php 
                                            $id = $row['id'];
                                            $second_statement = pg_query($connection,"SELECT * FROM surat where id=$id");
