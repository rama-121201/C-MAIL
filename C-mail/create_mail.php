<?php
  ...
  $statement = pg_query($connection,"SELECT * FROM surat;");
...
<head>
    ...
    <link rel="shortcut icon" href="./aku.jpeg">
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="sidebar col-md-3 col-sm-3 d-md-block d-sm-block d-none" style="background-image: linear-gradient(to bottom left, #f17a09,#fc00ff); ,height: 660px;">
          <div class="row text-center">
            <div class="col-md-11 mt-3 ">
              <img class="rounded-circle ms-3"src="./aku.jpeg" alt="" width="200px" height="200px"> <br>
              <p class="text-white fw-bold ms-3 fs-3 mt-2">Mail</p>
            </div>
                  ...
                  <li class="active">
                    <div class="my-4">
                      <a href="./create_mail.php" class="text-decoration-none text-white">
                        <h5><i class="bi bi-pencil ms-5 me-3"></i>Membuat Surat</h5>
                      </a>
                    </div>
                  </li>
                  <li class="passive">
                    <div class="my-4">
                      <a href="./profile.html" class="menu-active text-decoration-none text-white">
                        <h5><i class="bi bi-person-check ms-5 me-3 text-white"></i>Profile Saya</h5>
                      </a>
                    </div>
                  </li>               
                </ul>
            ...
            <div class="card-body">
                <form method="POST" action= "Backend/tambah_proses.php">
                        <div class="card-title ">
                                <h5><b>Buat Pesan</b></h5>
                                <h6 class="text-muted">Kelola informasi profil Anda untuk mengontrol, melindungi, dan mengamankan akun Anda</h6>
                                <hr>
                        </div>
                        ...
                        <div class="text-center mt-5">
                            <input type="submit" name="submit" class="btn" style="background-color: #00dbde; color: aliceblue;" value="SIMPAN" onclick="return confirm('Are you sure ?')">
                        </div>
